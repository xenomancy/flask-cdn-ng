...
Flask-CDN-NG allows you to easily serve all your `Flask`_ application's
...
Flask-CDN-NG replaces the URLs that Flask's :func:`flask.url_for` function would
...
**Note**: Flask-CDN-NG currently only supports applications
...
Flask-CDN-NG is incredibly simple to use. In order to start serving your
Flask application's assets from Amazon CDN, the first thing to do is let
Flask-CDN-NG know about your :class:`flask.Flask` application object.
...
care of. In these cases, Flask-CDN-NG provides a simple function,
...
settings to control the behaviour of Flask-CDN-NG. None of the settings are
required.
...
`CDN_TIMESTAMP`             Specifies whether or not to add a timestamp to the
                            generated urls.
                            **Default:** `True`
`CDN_MANIFEST`              Specifies whether or not to add a checksum from
                            manifest file to the generated url.
                            **Default** `False`
`CDN_MANIFEST_URL`          URI to a manifest file.
                            Eg. http://my.host.net/MANIFEST
                            **Default** `None`
=========================== ===================================================
...
Flask-CDN-NG is a very simple extension. The few exposed objects, methods
